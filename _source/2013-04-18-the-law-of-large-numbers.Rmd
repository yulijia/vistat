...
whether the sample mean approaches to the population mean. Here is the [Chi-squared distribution](http://en.wikipedia.org/wiki/Chi-squared_distribution) example.
