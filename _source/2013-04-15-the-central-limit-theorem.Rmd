...
```{r poisson-distribution-clt, fig.show='animate', interval=.2, fig.height=8, fig.width=8}
library(animation)
...
```{r cauchy-distribution-clt, fig.show='animate', interval=.2, fig.height=8, fig.width=8}
ani.options(nmax = 100, interval = 0.1)
par(mar = c(3, 3, 1, 0.5), mgp = c(1.5, 0.5, 0), tcl = -0.3)
