...
The function `newton.method()` in the [**animation** package](http://yihui.name/animation) gives a 
demonstration of the Newton-Raphson Method. The function used here is
...
library(animation)
ani.options(nmax = 100, interval = .5)
