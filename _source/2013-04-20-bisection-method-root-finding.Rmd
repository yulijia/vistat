...
formulas](http://en.wikipedia.org/wiki/Vieta's_formulas) to solving the [polynomial
...
Next, I will apply the [**animation** package](http://yihui.name/animation)'s function
...
Here we can see the example of Bisection Method for Root finding, the continuous function is
